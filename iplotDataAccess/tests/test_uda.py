...
class TestUDAAccess(unittest.TestCase):
    ...
    def test_UDAAccessISO(self)-> None:
        dobj=self.da.getData(self.ds,varname="BUIL-SYSM-COM-4503-BU:SRV6101-NSBPS",tsS="2022-05-04T12:30:00",tsE="2022-05-05T12:30:00",nbp=-1)
    ...
    def test_UDAAccessNano(self)-> None:
        dobj=self.da.getData(self.ds,varname="BUIL-SYSM-COM-4503-BU:SRV6101-NSBPS",tsS="1651667400000000000",tsE="1651753797000000000",nbp=-1)
    ...
    def test_UDAAccessInvVar(self)-> None:
        dobj=self.da.getData(self.ds,varname="BUIL-SYSM-COM-XX03-BU:SRV6101-NSBPS",tsS="1651667400000000000",tsE="1651753797000000000",nbp=-1)
        self.assertEqual(len(dobj.xdata),0)

    def test_UDAAccessNoData(self)-> None:
        dobj=self.da.getData(self.ds,varname="UTIL-HV-M1:TS2000-QT01",tsS="2022-06-14T02:26:02",tsE="2022-06-14T12:26:06",nbp=-1)
        self.assertEqual(len(dobj.xdata),0)
